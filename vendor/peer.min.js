parcelRequire = function(e, r, t, n) {
    ...
    "kdPp": [function(require, module, exports) {
        ...
        r.prototype.unpack = function() {
            ...
            case 215:
                return;
            case 216:
                return t = this.unpack_uint16(),
                this.unpack_string(t);
            case 217:
                return t = this.unpack_uint32(),
                this.unpack_string(t);
            case 218:
                return t = this.unpack_uint16(),
                this.unpack_raw(t);
        ...
        r.prototype.unpack_string = function(t) {
            for (var e, i, r = this.read(t), n = 0, u = ""; n < t; )
                (e = r[n]) < 128 ? (u += String.fromCharCode(e),
                n++) : (192 ^ e) < 32 ? (i = (192 ^ e) << 6 | 63 & r[n + 1],
                u += String.fromCharCode(i),
                n += 2) : (i = (15 & e) << 12 | (63 & r[n + 1]) << 6 | 63 & r[n + 2],
                u += String.fromCharCode(i),
                n += 3);
            return this.index += t,
            u
        ...
        n.prototype.pack = function(t) {
            ...
            if ("string" === i)
                ...
                if (null === t)
                    ...
                    if (r == Array)
                        this.pack_array(t);
                    else if (r == Blob || r == File || t instanceof Blob || t instanceof File)
                        this.pack_bin(t);
        ...
        n.prototype.pack_object = function(t) {
            ...
            for (var i in t)
                t.hasOwnProperty(i) && (this.pack(i),
                this.pack(t[i]))
        }
        ,
    ...
    "iSxC": [function(require, module, exports) {
        ...
        function s(e) {
            return "boolean" != typeof e ? new Error("Argument type: " + t(e) + ". Please use a boolean.") : (n = e,
            e ? "adapter.js logging disabled" : "adapter.js logging enabled")
        }
        function a(e) {
            return "boolean" != typeof e ? new Error("Argument type: " + t(e) + ". Please use a boolean.") : (r = !e,
            ...
            if (t.mediaDevices) {
                var i = e.detectBrowser(r)
                    ...
                    return Object.keys(e).forEach(function(t) {
                        if ("require" !== t && "advanced" !== t && "mediaSource" !== t) {
                            ...
                            if (void 0 !== n.ideal) {
                                ...
                                var a = {};
                                "number" == typeof n.ideal ? (a[i("min", t)] = n.ideal,
                                r.optional.push(a),
                                (a = {})[i("max", t)] = n.ideal,
                                r.optional.push(a)) : (a[i("", t)] = n.ideal,
                                r.optional.push(a))
                            }
                            void 0 !== n.exact && "number" != typeof n.exact ? (r.mandatory = r.mandatory || {},
                            r.mandatory[i("", t)] = n.exact) : ["min", "max"].forEach(function(e) {
                                void 0 !== n[e] && (r.mandatory = r.mandatory || {},
                  ...
                  , c = function(e, r) {
                    ...
                    return n("chrome: " + JSON.stringify(e)),
                    r(e)
                }
                  , d = function(e) {
    ...
    "uI5X": [function(require, module, exports) {
        ...
        function u(t) {
            var r = e.detectBrowser(t);
            if (!t.RTCPeerConnection && t.webkitRTCPeerConnection && (t.RTCPeerConnection = t.webkitRTCPeerConnection),
            t.RTCPeerConnection) {
                ...
                t.RTCPeerConnection.prototype.addIceCandidate = function() {
                    return arguments[0] ? r.version < 78 && arguments[0] && "" === arguments[0].candidate ? Promise.resolve() : n.apply(this, arguments) : (arguments[1] && arguments[1].apply(null),
                    Promise.resolve())
                }
            }
        }
    ...
    "YHvh": [function(require, module, exports) {
        ...
        r.writeCandidate = function(r) {
            ...
            return e.push("typ"),
            e.push(t),
            "host" !== t && r.relatedAddress && r.relatedPort && (e.push("raddr"),
            e.push(r.relatedAddress),
            e.push("rport"),
            e.push(r.relatedPort)),
            r.tcpType && "tcp" === r.protocol.toLowerCase() && (e.push("tcptype"),
            e.push(r.tcpType)),
            (r.usernameFragment || r.ufrag) && (e.push("ufrag"),
        ...
        r.writeFmtp = function(r) {
            var e = ""
              , t = r.payloadType;
            if (void 0 !== r.preferredPayloadType && (t = r.preferredPayloadType),
        ...
        r.writeRtcpFb = function(r) {
            var e = ""
              , t = r.payloadType;
            return void 0 !== r.preferredPayloadType && (t = r.preferredPayloadType),
            r.rtcpFeedback && r.rtcpFeedback.length && r.rtcpFeedback.forEach(function(r) {
        ...
        r.parseSsrcMedia = function(r) {
            var e = r.indexOf(" ")
              ...
              , n = r.indexOf(":", e);
            return n > -1 ? (t.attribute = r.substr(e + 1, n - e - 1),
            t.value = r.substr(n + 1)) : t.attribute = r.substr(e + 1),
            t
        }
        ,
        ...
        r.parseRtpParameters = function(e) {
            for (var t = {
                ...
                if (i) {
                    ...
                    switch (p.parameters = c.length ? r.parseFmtp(c[0]) : {},
        ...
        r.parseRtpEncodingParameters = function(e) {
            ...
            a.codecs.forEach(function(r) {
                if ("RTX" === r.name.toUpperCase() && r.parameters.apt) {
                    ...
                    n.push(e),
                    s && ((e = JSON.parse(JSON.stringify(e))).fec = {
                        ssrc: c,
        ...
        r.writeMediaSection = function(e, t, n, a) {
            ...
            if (s += r.writeIceParameters(e.iceGatherer.getLocalParameters()),
            ...
            e.rtpSender) {
                ...
                e.sendEncodingParameters[0].rtx && (s += "a=ssrc:" + e.sendEncodingParameters[0].rtx.ssrc + " " + i,
    ...
    "NJ2u": [function(require, module, exports) {
        ...
        function r(t, r, n, a, i) {
            ...
            if (s += e.writeIceParameters(t.iceGatherer.getLocalParameters()),
            ...
            t.rtpSender) {
                ...
                t.sendEncodingParameters[0].rtx && (s += "a=ssrc:" + t.sendEncodingParameters[0].rtx.ssrc + " " + c,
            ...
            return e.codecs.forEach(function(n) {
                for (var i = 0; i < t.codecs.length; i++) {
                    ...
                    if (n.name.toLowerCase() === s.name.toLowerCase() && n.clockRate === s.clockRate) {
                        if ("rtx" === n.name.toLowerCase() && n.parameters && s.parameters.apt && !a(n, s, e.codecs, t.codecs))
                            continue;
        ...
        module.exports = function(c, d) {
            function p(e, t) {
                t.addTrack(e),
                t.dispatchEvent(new c.MediaStreamTrackEvent("addtrack",{
                    track: e
                }))
            }
            function l(e, t, r, n) {
            ...
            var f = function(t) {
                ...
                switch (t.rtcpMuxPolicy || (t.rtcpMuxPolicy = "require"),
                ...
                if (t.iceServers = n(t.iceServers || [], d),
                this._iceGatherers = [],
                ...
                if (!a.onlocalcandidate) {
                    ...
                    a.onlocalcandidate = function(i) {
                        if (!(n.usingBundle && r > 0)) {
                            ...
                            l && (n._dispatchEvent("icecandidate", new Event("icecandidate")),
            ...
            f.prototype._transceive = function(t, r, n) {
                ...
                r && t.rtpSender && (i.encodings = t.sendEncodingParameters,
                i.rtcp = {
                    cname: e.localCName,
                ...
                t.rtpSender.send(i)),
                n && t.rtpReceiver && i.codecs.length > 0 && ("video" === t.kind && t.recvEncodingParameters && d < 15019 && t.recvEncodingParameters.forEach(function(e) {
                    delete e.rtx
                }),
                ...
                if ("offer" === t.type)
                    ...
                    r.forEach(function(t, r) {
                        ...
                        if (!(e.isRejected(t) && 0 === e.matchPrefix(t, "a=bundle-only").length) && !i.rejected) {
                            ...
                            c && (v.role = "server"),
                            s.usingBundle && 0 !== r || (s._gather(i.mid, r),
            ...
            f.prototype.setRemoteDescription = function(t) {
                ...
                return r.canTrickleIceCandidates = !!g && g.substr(14).split(" ").indexOf("trickle") >= 0,
                u.forEach(function(i, o) {
                    ...
                    if (g || "application" === u && ("DTLS/SCTP" === y || "UDP/DTLS/SCTP" === y))
                        ...
                        if (("offer" === t.type || "answer" === t.type) && !g && m && o > 0 && r.transceivers[o] && (r._disposeIceAndDtlsTransports(o),
                        ...
                        "offer" !== t.type || g) {
                            if ("answer" === t.type && !g) {
                                ...
                                j.length && "new" === w.state && (!h && !G || m && 0 !== o ? j.forEach(function(e) {
                                    s(C.iceTransport, e)
                                }) : w.setRemoteCandidates(j)),
                                m && 0 !== o || ("new" === w.state && w.start(P, I, "controlling"),
                                ...
                                !_ || "sendrecv" !== S && "sendonly" !== S ? delete C.rtpReceiver : (D = _.track,
                                T ? (n[T.stream] || (n[T.stream] = new c.MediaStream),
                                p(D, n[T.stream]),
                                f.push([D, _, n[T.stream]])) : (n.default || (n.default = new c.MediaStream),
                                p(D, n.default),
                            ...
                            j.length && "new" === C.iceTransport.state && (!G || m && 0 !== o ? j.forEach(function(e) {
                                s(C.iceTransport, e)
                            }) : C.iceTransport.setRemoteCandidates(j)),
                            x = c.RTCRtpReceiver.getCapabilities(u),
                            d < 15019 && (x.codecs = x.codecs.filter(function(e) {
                                return "rtx" !== e.name
                            })),
                            k = C.sendEncodingParameters || [{
                                ssrc: 1001 * (2 * o + 2)
                            ...
                            if ("sendrecv" === S || "sendonly" === S) {
                                ...
                                A)
                                    D = _.track,
                                    T && "-" === T.stream || (T ? (n[T.stream] || (n[T.stream] = new c.MediaStream,
                                    ...
                                    N = n[T.stream]) : (n.default || (n.default = new c.MediaStream),
                                    N = n.default)),
                                    N && (p(D, N),
                                    C.associatedRemoteMediaStreams.push(N)),
                                    f.push([D, _, N])
                            } else
                                C.rtpReceiver && C.rtpReceiver.track && (C.associatedRemoteMediaStreams.forEach(function(e) {
                                    var t, r, n = e.getTracks().find(function(e) {
                                        return e.id === C.rtpReceiver.track.id
                                    });
                                    n && (t = n,
                                    (r = e).removeTrack(t),
                                    r.dispatchEvent(new c.MediaStreamTrackEvent("removetrack",{
                                        track: t
                                    })))
                                }),
            ...
            f.prototype.createOffer = function() {
                ...
                for (t.transceivers.forEach(function(e) {
                    ...
                    n > 0 && (t._createTransceiver("audio"),
                    n--),
                    a > 0 && (t._createTransceiver("video"),
                    a--);
                ...
                t.transceivers.forEach(function(r, n) {
                    ...
                    r.mid = s,
                    r.iceGatherer || (r.iceGatherer = t._createIceGatherer(n, t.usingBundle));
                ...
                t.transceivers.forEach(function(e, s) {
                    if (!(s + 1 > i)) {
                        ...
                        if (e.stream)
                            ...
                            o && d >= 15019 && "video" === e.kind && !e.sendEncodingParameters[0].rtx && (e.sendEncodingParameters[0].rtx = {
            ...
            f.prototype.addIceCandidate = function(t) {
                ...
                return t && void 0 === t.sdpMLineIndex && !t.sdpMid ? Promise.reject(new TypeError("sdpMLineIndex or sdpMid required")) : new Promise(function(a, i) {
                    if (!n._remoteDescription)
                        return i(o("InvalidStateError", "Can not add ICE candidate without a remote description"));
                    if (t && "" !== t.candidate) {
                        ...
                        for (var u = 0; u < n.transceivers.length && (n.transceivers[u].rejected || (n.transceivers[u].iceTransport.addRemoteCandidate({}),
    ...
    "XRic": [function(require, module, exports) {
        ...
        function a(n) {
            ...
            !n.RTCRtpSender || "dtmf"in n.RTCRtpSender.prototype || Object.defineProperty(n.RTCRtpSender.prototype, "dtmf", {
                get: function() {
                    return void 0 === this._dtmf && ("audio" === this.track.kind ? this._dtmf = new n.RTCDtmfSender(this) : "video" === this.track.kind && (this._dtmf = null)),
                    this._dtmf
                }
            }),
            n.RTCDtmfSender && !n.RTCDTMFSender && (n.RTCDTMFSender = n.RTCDtmfSender);
            var c = (0,
            r.default)(n, i.version);
            n.RTCPeerConnection = function(r) {
                return r && r.iceServers && (r.iceServers = (0,
                t.filterIceServers)(r.iceServers, i.version),
            ...
            !(o.version > 55 && "autoGainControl"in n.mediaDevices.getSupportedConstraints())) {
                ...
                if (i && i.prototype.applyConstraints) {
                    ...
                    i.prototype.applyConstraints = function(e) {
                        return "audio" === this.kind && "object" === r(e) && (e = JSON.parse(JSON.stringify(e)),
    ...
    "Fzdr": [function(require, module, exports) {
        ...
        function s(t) {
            ...
            if ("object" === a(t) && (t.RTCPeerConnection || t.mozRTCPeerConnection)) {
                if (!t.RTCPeerConnection && t.mozRTCPeerConnection && (t.RTCPeerConnection = t.mozRTCPeerConnection),
                r.version < 53 && ["setLocalDescription", "setRemoteDescription", "addIceCandidate"].forEach(function(e) {
                    var r = t.RTCPeerConnection.prototype[e]
                      , n = i({}, e, function() {
                        return arguments[0] = new ("addIceCandidate" === e ? t.RTCIceCandidate : t.RTCSessionDescription)(arguments[0]),
            ...
            if ("object" === a(e) && e.RTCPeerConnection) {
                ...
                t && (e.RTCPeerConnection.prototype.addTransceiver = function() {
                    ...
                    if (r) {
                        var {sender: o} = n
                          , i = o.getParameters();
                        "encodings"in i || (i.encodings = e.sendEncodings,
            ...
            t.RTCPeerConnection = function(t, o) {
                if (t && t.iceServers) {
                    for (var n = [], i = 0; i < t.iceServers.length; i++) {
                        ...
                        !a.hasOwnProperty("urls") && a.hasOwnProperty("url") ? (e.deprecated("RTCIceServer.url", "RTCIceServer.urls"),
                        (a = JSON.parse(JSON.stringify(a))).urls = a.url,
                        delete a.url,
                        n.push(a)) : n.push(t.iceServers[i])
                    }
                    t.iceServers = n
                }
                return new r(t,o)
        ...
        function a(n) {
            if (n.RTCIceCandidate && !(n.RTCIceCandidate && "foundation"in n.RTCIceCandidate.prototype)) {
                ...
                n.RTCIceCandidate = function(t) {
                    if ("object" === i(t) && t.candidate && 0 === t.candidate.indexOf("a=") && ((t = JSON.parse(JSON.stringify(t))).candidate = t.candidate.substr(2)),
                ...
                n.RTCPeerConnection.prototype.setRemoteDescription = function() {
                    ...
                    if (function(t) {
                        ...
                        u), c = function(t, n) {
                            ...
                            return i.length > 0 ? r = parseInt(i[0].substr(19), 10) : "firefox" === o.browser && -1 !== n && (r = 2147483637),
                            r
                        }(arguments[0], i);
        ...
        function m() {
            ...
            case "chrome":
                if (!r || !r.shimPeerConnection || !o.shimChrome)
                    return m("Chrome shim is not included in this adapter release."),
                    d;
            ...
            case "firefox":
                if (!s || !s.shimPeerConnection || !o.shimFirefox)
                    return m("Firefox shim is not included in this adapter release."),
                    d;
            ...
            case "edge":
                if (!i || !i.shimPeerConnection || !o.shimEdge)
                    return m("MS edge shim is not included in this adapter release."),
                    d;
            ...
            case "safari":
                if (!t || !o.shimSafari)
                    return m("Safari shim is not included in this adapter release."),
                    d;
    ...
    "BHXf": [function(require, module, exports) {
        ...
        exports.util = new (function() {
            ...
            return r.prototype.noop = function() {}
            ,
    ...
    "JJlS": [function(require, module, exports) {
        ...
        i.prototype.emit = function(e, n, r, o, s, i) {
            ...
            if (a.fn) {
                ...
                for (u = 1,
                f = new Array(l - 1); u < l; u++)
                    f[u - 1] = arguments[u];
                a.fn.apply(a.context, f)
            } else {
                var v, h = a.length;
                for (u = 0; u < h; u++)
                    switch (a[u].once && this.removeListener(e, a[u].fn, void 0, !0),
                    l) {
                    case 1:
        ...
        i.prototype.removeAllListeners = function(e) {
            var r;
            return e ? (r = t ? t + e : e,
            this._events[r] && s(this, r)) : (this._events = new n,
            this._eventsCount = 0),
            this
        }
        ,
    ...
    "wJlv": [function(require, module, exports) {
        ...
        var e = this && this.__extends || function() {
            ...
            return function(t, n) {
                ...
                e(t, n),
                t.prototype = null === n ? Object.create(n) : (s.prototype = n.prototype,
                new s)
            }
        }()
        ...
        var r = require("eventemitter3")
          ...
          , a = function(t) {
            function o(e, n, s, o, r, i) {
                ...
                c._messagesQueue = [];
                var a = e ? "wss://" : "ws://";
                return c._baseUrl = a + n + ":" + s + o + "peerjs?key=" + r,
                c
            }
            return e(o, t),
            o.prototype.start = function(e, t) {
                ...
                !this._socket && this._disconnected && (this._socket = new WebSocket(s),
                ...
                this._socket.onclose = function(e) {
                    n._disconnected || (i.default.log("Socket closed.", e),
                    n._cleanup(),
                    n._disconnected = !0,
                ...
                this._socket.onopen = function() {
                    n._disconnected || (n._sendQueuedMessages(),
        ...
        var i = require("./util")
          ...
          , a = function() {
            ...
            return o.prototype.startConnection = function(e) {
                ...
                if (this.connection.peerConnection = n,
            ...
            o.prototype._setupListeners = function(e) {
                ...
                e.onicecandidate = function(e) {
                    e.candidate && e.candidate.candidate && (r.default.log("Received ICE candidates for " + t + ":", e.candidate),
                    s.socket.send({
                ...
                return n(this, void 0, Promise, function() {
                    ...
                    return t(this, function(t) {
                        ...
                        case 4:
                            ...
                            this.connection.type === c.ConnectionType.Data && (d = this.connection,
                            s = e(e({}, s), {
                                label: d.label,
                                reliable: d.reliable,
                            ...
                            [3, 6];
                        case 5:
                            return "OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer" != (l = t.sent()) && (o.emitError(c.PeerErrorType.WebRTC, l),
                ...
                return n(this, void 0, Promise, function() {
                    ...
                    return t(this, function(t) {
                        ...
                        case 1:
                            ...
                            [4, a.addIceCandidate(new RTCIceCandidate({
                                sdpMid: i,
                                sdpMLineIndex: o,
                                candidate: n
                            }))];
                        case 2:
                            return t.sent(),
                            r.default.log("Added ICE candidate for:" + this.connection.peer),
                            [3, 4];
                        case 3:
                            return d = t.sent(),
            ...
            o.prototype._addTracksToConnection = function(e, n) {
                if (r.default.log("add tracks from stream " + e.id + " to peer connection"),
                !n.addTrack)
    ...
    "dbHP": [function(require, module, exports) {
        ...
        var e = this && this.__extends || function() {
            ...
            return function(t, o) {
                ...
                e(t, o),
                t.prototype = null === o ? Object.create(o) : (r.prototype = o.prototype,
                new r)
            }
        }()
          ...
          , c = function(r) {
            ...
            l.prototype.answer = function(e, r) {
                ...
                this._localStream)
                    ...
                    this._negotiator.startConnection(t(t({}, this.options._payload), {
                        _stream: e
                    }));
    ...
    "GGp6": [function(require, module, exports) {
        ...
        var e = this && this.__extends || function() {
            ...
            return function(t, r) {
                ...
                e(t, r),
                t.prototype = null === r ? Object.create(r) : (o.prototype = r.prototype,
                new o)
            }
        }()
        ...
        var r = require("eventemitter3")
          ...
          , n = function(t) {
            function r() {
                ...
                return e.fileReader = new FileReader,
                e._queue = [],
                e._processing = !1,
        ...
        var i = require("./util")
          ...
          , l = function(n) {
            function s(e, t, l) {
                ...
                return f.stringify = JSON.stringify,
                f.parse = JSON.parse,
                f._buffer = [],
                f._bufferSize = 0,
                f._buffering = !1,
                ...
                f._encodingQueue.on("error", function() {
                    o.default.error("DC#" + f.connectionId + ": Error occured in encoding from blob to arraybuffer, close DC"),
                    f.close()
                }),
                f._negotiator = new r.Negotiator(f),
                f._negotiator.startConnection(f.options._payload || {
                    originator: !0
                }),
                f
            }
            ...
            s.prototype._handleDataMessage = function(e) {
                ...
                if (this.serialization === a.SerializationType.Binary || this.serialization === a.SerializationType.BinaryUTF8) {
                    ...
                    this.serialization === a.SerializationType.JSON && (s = this.parse(o));
            ...
            s.prototype.send = function(e, t) {
                if (this.open)
                    ...
                    n.prototype.emit.call(this, a.ConnectionEventType.Error, new Error("Connection is not open. You should listen for the `open` event before sending messages."))
            }
            ,
            ...
            s.prototype._trySend = function(e) {
                ...
                try {
                    ...
                    return o.default.error("DC#:" + this.connectionId + " Error when sending:", n),
                    this._buffering = !0,
                    this.close(),
                    !1
                }
                ...
                return t(this, void 0, Promise, function() {
                    ...
                    return e(this, function(e) {
                        ...
                        case 3:
                            ...
                            i = "",
                            "/" === this._options.path && this._options.host !== o.util.CLOUD_HOST && (i = " If you passed in a `path` to your self-hosted PeerServer, you'll also need to pass in that same path when creating a new Peer."),
                    ...
                    return e(this, function(e) {
                        ...
                        case 2:
                            if (200 !== (r = e.sent()).status) {
                                if (401 === r.status)
                                    throw s = "",
                                    s = this._options.host === o.util.CLOUD_HOST ? "It looks like you're using the cloud server. You can email team@peerjs.com to enable peer listing for your API key." : "You need to enable `allow_discovery` on your self-hosted PeerServer to use this feature.",
        ...
        var i = require("eventemitter3")
          ...
          , f = function(o) {
            function i(e, n) {
                ...
                c._options.path && ("/" !== c._options.path[0] && (c._options.path = "/" + c._options.path),
                ...
                s.util.supports.audioVideo || s.util.supports.data ? r && !s.util.validateId(r) ? (c._delayedAbort(u.PeerErrorType.InvalidID, 'ID "' + r + '" is invalid'),
                c) : (r ? c._initialize(r) : c._api.retrieveId().then(function(e) {
                    return c._initialize(e)
                }).catch(function(e) {
                    return c._abort(u.PeerErrorType.ServerError, e)
                }),
                c) : (c._delayedAbort(u.PeerErrorType.BrowserIncompatible, "The current browser does not support WebRTC"),
                c)
            }
            return e(i, o),
            ...
            i.prototype._createServerConnection = function() {
                ...
                t.on(u.SocketEventType.Disconnected, function() {
                    e.disconnected || (e.emitError(u.PeerErrorType.Network, "Lost connection to server."),
                    e.disconnect())
                }),
            ...
            i.prototype._handleMessage = function(e) {
                ...
                case u.ServerMessageType.Offer:
                    ...
                    if ((_ = this.getConnection(s, c)) && (_.close(),
                    a.default.warn("Offer received for existing Connection ID:" + c)),
                ...
                default:
                    if (!i)
                        return void a.default.warn("You received a malformed message from " + s + " of type " + o);
                    var _;
                    c = i.connectionId;
            ...
            i.prototype.connect = function(e, t) {
                if (void 0 === t && (t = {}),
                this.disconnected)
                    return a.default.warn("You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect, or call reconnect on this peer if you believe its ID to still be available."),
            ...
            i.prototype.call = function(e, t, n) {
                if (void 0 === n && (n = {}),
                this.disconnected)
                    return a.default.warn("You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect."),
                    void this.emitError(u.PeerErrorType.Disconnected, "Cannot connect to new Peer after disconnecting from server.");
                if (t) {
                    n._stream = t;
            ...
            i.prototype.destroy = function() {
                this.destroyed || (a.default.log("Destroy peer with ID:" + this.id),
                this.disconnect(),
                this._cleanup(),
                this._destroyed = !0,
